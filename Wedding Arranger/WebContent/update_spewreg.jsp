...
<title>Wedding Arrenger Updation Form</title>
</head>
...
%>
<h1 align="center">Wedding Arranger Updation Page</h1>
<hr color="black">

<table border="1px" align="center" cellspacing="0">
<form name=regform action="update_wreg.jsp" onsubmit="return validate()">
<tr>
